...
const WinebottleManager = require("./WinebottleManager");

models.winebottle = new WinebottleManager();
models.winebottle.setDatabase(pool);

const TastingManager = require("./TastingManager");
